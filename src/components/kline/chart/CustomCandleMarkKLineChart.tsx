...
import { init, dispose, Coordinate } from "klinecharts";
import generatedKLineDataList from "../utils/generatedKLineDataList";
import Layout from "../Layout";

const CustomCandleMarkKLineChart: React.FunctionComponent<{}> = () => {
      ...
      kLineChart.createAnnotation([
        ...
        },
        {
          point: {
            ...
            value: kLineDataList[kLineDataList.length - 45].high,
          },
          styles: {
            symbol: {
              position: "point",
...
export default CustomCandleMarkKLineChart;
